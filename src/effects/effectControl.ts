import type { EffectEvent, LayerDef, Slots } from './controlMessages';
...
export interface EffectControl {
  ...
  // Replace the whole live layer stack: covers reorder, blend, add, remove, and
  // swap-kind in one op.
  setLayers(layers: LayerDef[]): Promise<void>;
  ...
  setRamp(layer: string, ramp: Ramp): Promise<void>;
